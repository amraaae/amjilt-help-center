    ...
    <div className="w-full px-20">
      ...
      <div class="flex flex-col space-y-6">
        <div class="flex space-x-4 items-center">
          ...
          <h2 class="text-lg font-medium text-gray-800">Сургалтын төв хуудсын хөтөлбөр хичээлүүд хэсгийг сонгоно.</h2>
        </div>
        <div class="flex space-x-4 items-center">
          <div class="rounded-full h-6 w-6 bg-gray-300 flex items-center justify-center">
            <span class="text-white text-sm font-bold">2</span>
          </div>
          <h2 class="text-lg font-medium text-gray-800">Дэлгэцийн зүүн дээд хэсэгт байх ногоон өнгийн нэмэх гэсэн дээр дарна.</h2>
        </div>
      </div>
    </div>
  );
